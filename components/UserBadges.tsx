...
import { Rocket, Gem, Shield, Bug, Code, Hammer, Handshake, Crown, Sparkles, Gamepad2, Ghost, Bot } from 'lucide-react';
...
export const UserBadges: React.FC<UserBadgesProps> = ({ badges, className = "" }) => {
    ...
    const getIcon = (badge: UserBadge) => {
        switch (badge) {
            ...
            case UserBadge.PARTNER: return <Handshake size={14} className="text-[#5865F2]" />;
